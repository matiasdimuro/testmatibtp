		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Test Mati BTP",
									"targetURL": "#hexagontestmatibtp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hexagontestmatibtp-display": {
								"semanticObject": "hexagontestmatibtp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hexagon.testmatibtp",
									"url": sap.ui.require.toUrl("hexagon/testmatibtp")
								}
							}
						}
					}
